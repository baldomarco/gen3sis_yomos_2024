...
Yomos 2024 May 13-17, 2024\
Federseestation, Bad Buchau, Germany

::: {#right .flex-item style="flex: 1; display: flex; justify-content: center;"}
<img src="qr-code-workshop.jpg" style="width: 100px;"/> https://github.com/ohagen/gen3sis_yomos_2024
:::
...
This workshop is designed to provide foundational knowledge on how to use gen3sis for various research questions, which is crucial for defining models within the modeling cycle. The course will briefly introduce the philosophical context of natural science and the principles of mechanistic models. Participants will engage in hands-on exercises, applying gen3sis to explore hypotheses concerning the genesis and maintenance of biodiversity within the R programming environment. Practical experiences will equip attendees with the necessary background to craft their own biodiversity models. The workshop mainly uses simulated data, leading to valuable insights about the interplay between processes and patterns in biodiversity research. Please bring a laptop equipped with R and the latest version of gen3sis to participate effectively. For those eager to maximize their workshop experience, I recommend reading the [methods paper](https://doi.org/10.1371/journal.pbio.3001340) and exploring this [repo](https://github.com/ohagen/DispDiv3) which includes some of the materials (such as landscapes and configuration files) we'll be using. The related article is forthcoming and currently in press.
